...
export const getApprovalsQuerySchema = z.object({
  query: z.object({
    ...
    sortBy: z
      .enum(["createdAt", "dueDate", "reviewedAt", "title"])
      .default("createdAt")
      .optional(),
...
export const createChangeRequestSchema = z.object({
  ...
  body: z.object({
    ...
    requestedChanges: z
      .string()
      .min(1, "Requested changes description is required")
      .max(5000),
    reason: z.string().max(2000).optional().nullable(),
    requestedByCustomerId: z
      .string()
...
export type GetApprovalsQueryInput = z.infer<
  typeof getApprovalsQuerySchema
>["query"];
export type CreateChangeRequestInput = z.infer<
  typeof createChangeRequestSchema
>["body"];
export type RespondChangeRequestInput = z.infer<
  typeof respondChangeRequestSchema
>["body"];
