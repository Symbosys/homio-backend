...
// Sub-routes for Milestones, Progress, Approvals, Complaints, Site Visits, Expenses, Designs, Handovers & Timelines per Project
...
projectRoutes.use("/:projectId/timelines", timelineRoutes);
